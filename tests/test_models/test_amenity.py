...
class TestAmenity(unittest.TestCase):
    ...
    def test_documentation(self):
        ...
        self.assertIsNotNone(amenity.__doc__, "Missing: module documentation of file \"amenity.py\"")
...
# =========================
    ...
    def test_create_instance_from_dict_Amenity(self):
        """create a new instance Amenity using a dictionnary of another instance \
already created"""
        my_amenity = Amenity()
        my_amenity.name = "example"
...
updated_at has changed"""
    ...
    def test_create_from_dict_Amenity(self):
        ...
        self.assertEqual(my_amenity.name, "example")
        self.assertEqual(my_amenity.created_at, datetime(2022, 3, 2, 8, 30, 54, 356780))
